...
class PerformanceOptimizer:
    ...
    def optimize_database_queries():
        ...
        try:
            # Configurações de otimização para MySQL/PostgreSQL
            optimizations = [
        ...
        try:
            ...
            for index_query in indexes:
                try:
                    ...
                    # Se for erro de índice duplicado, loga como info, não warning
...
def measure_performance(f):
    ...
    def wrapper(*args, **kwargs):
        ...
        # Log performance se demorar mais que 1 segundo
